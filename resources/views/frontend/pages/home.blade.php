...
<div class="h-full w-full homeBanner">
    <div class="container mx-auto px-5 lg:px-12 h-full w-full">
        <div class="h-full w-full flex flex-col justify-center items-center z-20 text-center pt-8 pb-14">
            <h2 class="banner_text-one lg:text-3xl font_inter font-semibold text-white lg:pt-[11%]">Journey with Confidence <span class="text-[#579aff]">Migrate</span> with Us</h2>
            <h1 class="lg:text-8xl font-medium font_inter text-white z-10 lg:mt-16">Your Trusted Partner <span class="banner_main-text lg:inline-block">for Immigration</span>.</h1>
            <h6 class="font_inter font-semibold text-3xl z-20 text-white lg:mt-20">Visa Made Easy Dreams Made Possible</h6>
            <div class="z-10 flex justify-center items-center gap-4 lg:my-7">
                <img width="52px" src="{{asset('assets/home_Banner/CanadaFlag.png')}}" alt="CanadaFlag">
                {{-- "C:\laragon\www\k-graph\public\assets/home_Banner/CanadaFlag.png" --}}
                <div class="bg-blue-500 flex justify-center items-center rounded-full gap-5 pl-5">
                    <h6 class="text-white">Let's turn your vision into reality.</h6>
                    <div class="bg-white text-blue-600 hover:bg-blue-600 hover:text-white px-[20px] py-[10px] rounded-sm ease-in duration-500 cursor-pointer w-fit lg:rounded-full">
                        <a href="" class="h-full">Connect Us</a>
                    </div>
                </div>
            </div>
            <div class="z-10 flex justify-around items-center w-full lg:mb-10">
...
<div class="bg-[#051b3b]">
    ...
    <div class="serviceSection bg-[#051b3b]">
        <div class="container mx-auto px-5 lg:px-12 lg:py-16 h-full w-full">
            <div class="flex items-center">
                <h2 class="font_inter font-semibold text-[80px] text-white leading-none uppercase"><span class="inline-block">Our</span><span class="inline-block">Services</span></h2>
                <div class="w-full" style="margin-bottom: -6%;">
                    <div class="flex justify-end items-center">
                        <div class="commongrad rounded-full py-[2.5px]  w-fit">
                            <span class="px-5 text-white">Let's turn your vision into reality.</span>
                            <button class="bg-white px-8 py-1 text-[#0153d0] rounded-full">Connect Us</button>
                        </div>
                    </div>
                    <div class="w-full my-6" style="border: 2px solid #FFFFFF8C;"></div>
                </div>
            </div>
            <h4 class="text-white font_inter font-semibold text-[26px]">Visa Immigration for a Brighter You Future</h4>
            ...
            <div class="grid gap-5" style="grid-template-columns: 1fr 1fr 1fr 1fr">
                <div class="box-grading p-6 rounded-xl">
    ...
    <div class="whoSec bg-[#051b3b]">
        <div class="container mx-auto px-5 lg:px-12 lg:py-16 h-full w-full">
            <div class="flex items-center">
                <h2 class="font_inter font-semibold text-[80px] text-white leading-none uppercase"><span class="inline-block">Who</span><span class="inline-block">We Are</span></h2>
                <div class="w-full" style="margin-bottom: -6%;">
                    <div class="flex justify-end items-center">
            ...
            <p class="py-5 text-white font_inter font-medium text-[18px] w-[30%]">Navigate Your Canadian Immigration Journey with Confidence</p>
        </div>
    </div>
    ...
    <div class="Navigatesec bg-[#051b3b]">
        <div class="container mx-auto px-5 lg:px-12 lg:py-16 h-full w-full">
            ...
            <div class="flex justify-between items-start gap-5">
                <div class="w-1/2">
                    <h4 class="text-white font_inter font-semibold text-[30px] w-[75%]">Navigate Your Canadian Immigration Journey with Confidence</h4>
                    <p class="text-white font_inter font-thin text-justify text-[14px] py-4  w-[75%]">We enable some of the most demanding organizations to enrich customer experiences, optimize efficiencies, launch new platforms, and monetize data opportunities. We offer fully-managed and end-to-end technology, tools, talent, </p>
                    <h2 class="text-white font_inter font-bold text-[85px] leading-none">60+</h2>
                    <p class="text-white">Years of Experience</p>
                    <div class="my-6 flex items-start gap-5">
                        <div>
    ...
    <div class="RegulatedSec bg-black">
        <div class="container mx-auto px-5 lg:px-12 lg:py-16 h-full w-full">
            <div class="flex justify-center items-start gap-5">
                <div class="w-1/2">
                    <h2 class="text-white font_inter font-semibold text-2xl w-[55%]">Regulated Canadian Immigration Consultants (RCIC-IRB)</h2>
                    <p class="py-5 text-white font-normal font_inter text-[14px] w-[80%]">Proudly regulated by and in good standing with the College of Immigration and Citizenship Consultants (CICC). Jamie Dowla, registration #: R507233</p>
    ...
    <div class="testimonial bg-[#051b3b]">
        <div class="container mx-auto px-5 lg:px-12 lg:py-16 h-full w-full">
            <div class="flex items-end w-full gap-2">
                <h2 class="uppercase text-white font_inter font-semibold text-[50px] leading-none">Testimonials</h2>
                <div class="w-full" style="border: 2px solid #FFFFFF8C;margin-bottom: 8px;"></div>
            </div>
            <p class="py-5 text-white font_inter font-medium text-[18px] w-[30%]">Let’s See what our customers want to say</p>
            <p class="text-white font_inter font-normal text-justify text-[14px] w-[45%]">We enable some of the most demanding organizations to enrich customer experiences, optimize efficiencies, launch new platforms, and monetize data opportunities. We offer fully-managed and end-to-end technology, tools, talent, </p>
    ...
    <div class="BlogCRDS bg-[#051b3b]">
        <div class="container mx-auto px-5 lg:px-12 lg:py-16 h-full w-full">
            ...
            <p class="py-5 text-white font_inter font-medium text-[18px] w-[30%]">Canadian Immigration News, Tips, and Resources</p>
            <p class="text-white font_inter font-normal text-justify text-[14px] w-[45%]">Stay in the loop and keep up with all our news and updates!</p>
            ...
            <div class="pt-[20px] pb-[70px] grid gap-6" style="grid-template-columns: 1fr 1fr 1fr 1fr;">
                <div class="bg-white">
    ...
    <div class="explore-section bg-black">
        <div class="container mx-auto px-5 lg:px-12 lg:py-16 h-full w-full">
            ...
            <p class="text-white font_inter font-semibold text-[26px] w-[35%] mt-6">Learn About All of the Great Things Canada Has to Offer!</p>
        </div>
        <div class="flex justify-between items-center overflow-x-scroll gap-6 scrollbar-hidden pb-[100px]">
            <img class="pl-12" src="{{ asset('assets/home_Banner/sliderone.png') }}" alt="">
...
<div class="faq-section bg-[#F7FCFF]">
    <div class="container mx-auto px-5 lg:px-12 lg:py-16 h-full w-full">
        <div class="flex justify-center items-center flex-col">
            <h2 class="font_aktiv font-bold lg:text-[18px] faqSectHead text-[#07245A]">Have Any Questions?</h2>
            <div>
                <h2 class="font_aktiv font-bold lg:text-[32px] faqSectHeading text-[#07245A]">FAQs ?</h2>
...
<div class="get-in-Touch bg-[#051b3b] py-28">
    <div class="container mx-auto px-5 lg:px-12 h-full w-full">
        <div class="flex justify-center items-center flex-col ">
            <div class="flex items-center">
                <h2 class="font_inter font-semibold text-4xl gettouch uppercase gradient-text">Get IN TOUCH WITH US</h2>
                <img class="w-[70px]" src="{{ asset('assets/home_Banner/rocketicon.png') }}" alt="">
            </div>
            <p class="text-white lg:py-8 paddadjuster w-1/2 text-center font_inter font-semibold lg:text-[22px] gettouchpara">Labaton Keller Sucharow is elevating excellence through innovation, client service, and teamwork.</p>
            <div class="bg-[#0153d0] rounded-full py-[10px]">
                <span class="px-5 text-white">Have any doubt</span>
                <button class="bg-white px-8 py-1 text-[#0153d0] rounded-full">Enquiry Now</button>
            </div>
        </div>
    </div>
</div>
