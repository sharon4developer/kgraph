...
@section('content')
    ...
    <div class="h-full w-full homeBanner relative">
        ...
        <div class="container mx-auto px-5 lg:px-12 h-full w-full relative z-10">
            <div
                class="h-full w-full flex flex-col justify-center items-center text-center mb-4 md:pt-8 pb-14 gap-[20px] md:gap-[31px] lg:gap-0">
                <div
                    class="z-10 flex flex-col lg:flex-row items-center pt-[10%] lg:pt-[13%] xl:pt-[12%] banner-container-elem">
                    <img class="pt-[22px] md:pt-0 w-[40px] xl:w-[100px]"
                        src="{{ asset('assets/home_Banner/rocketicon.png') }}" alt="">
                    <h2
                        class="banner_text-one text-[20px]  lg:text-base xl:text-[26px] font_inter font-semibold text-white text-center">
                        Journey with Confidence <span class="text-[#579aff]">Migrate</span> with Us
                    </h2>
                </div>
                <h1
                    class="md:text-center text-[31px] md:text-[55px] lg:text-5xl xl:text-8xl lg:w-[60%] xl:w-[70%] font-medium font_inter gradient-text z-10 lg:mt-4 xl:mt-16 banner_main-text xl:inline-block banner-contain-text">
                    Your Trusted Partner for Immigration.
                </h1>
                <h6
                    class="font_inter font-semibold text-[12px] md:text-[20px] md:text-3xl lg:text-base xl:text-3xl z-20 text-white lg:mt-14 xl:mt-20 banner-container-elem">
                ...
                <div class="z-10 flex flex-row justify-center items-start md:items-center gap-4 lg:my-7">
                    ...
                    <div
                        ...
                        <h6 class="relative z-10 text-white text-[10px] md:text-[12px] xl:text-[16px]">Let's turn your
                            vision into reality.</h6>
                        <div
                ...
                <div class="z-10 flex flex-wrap md:flex-nowrap justify-around items-center py-5 w-full lg:mb-1 xl:mb-10">
                    ...
                    <img class="w-[50px] md:w-[100px] " src="{{ asset('assets/home_Banner/airtasker.png') }}"
                        alt="">
                </div>
    ...
    <div class="bg-[#051b3b]">
        ...
        <div class="serviceSection gradient-evition relative overflow-hidden z-10 bg-[#051b3b]">
            <div class="container mx-auto px-5 lg:px-12 lg:py-16 h-full w-full pt-10 lg:pt0">
                <div class="md:flex items-center">
                    <h2
                        class="left-to-right-animation font_inter font-semibold text-[46px] md:text-[50px] xl:text-[100px] text-white leading-none uppercase gradient-text">
                        <span class="inline-block">Our</span><span class="inline-block">Services</span>
                    </h2>
                    <div class="md:pl-2 w-full" style="margin-bottom: -6%;">
                        <div class="my-4 md:my-0 flex justify-center md:justify-end items-center">
                            <div
                                ...
                                <h6 class="relative z-10 text-white text-[10px] md:text-[12px] xl:text-[16px]">Let's turn
                ...
                <h4
                    class="text-white font_inter font-semibold text-[22px] xl:text-[36px] py-4 lg:pb-0 left-to-right-animation">
                    Visa Immigration for a Brighter You Future</h4>
                <p class="text-white font_inter font-thin text-justify text-[14px] xl:text-[20px] left-to-right-animation">
                    We enable some of the most demanding organizations to enrich customer experiences, optimize
                    efficiencies, launch new platforms, and monetize data opportunities. We offer fully-managed and
                    end-to-end technology, tools, talent, </p>
                <div class="gap-5 flex justify-start md:justify-center lg:justify-between items-center scrollbar-hidden"
                    style="">

                    @foreach ($services as $data)
                        <div
                            class="box-grading mb-9 lg:mb-0 p-4 lg:p-6 h-[400px] lg:h-[300px] xl:h-[450px] w-full md:w-[28%] lg:w-full rounded-xl cursor-pointer">
                            <h2 class="text-white font_inter text-[20px] font-bold pb-8 flex flex-col"><span
                                    class="xl:inline-block">{{ $data->title }}</span>
                                {{-- <span class="xl:inline-block">nationals</span> --}}
                            </h2>
                            <div class="text-white font_inter font-bold text-[16px] md:text-sm py-3">Choose Your Services
                            </div>

                            <div class="flex flex-col xl:mt-4 gap-3 knowbutton ">
                                @foreach ($data->ServicePoint as $points)
                                    <button
                                        class="flex items-center justify-between gap-4 border border-white rounded-full px-6 py-1 py-2">
            ...
            <div class="container mx-auto px-5 lg:px-12 lg:py-16 h-full w-full">
                <div class="md:flex items-end ">
                    <div class="lg:w-full flex items-end">
                        <h2
                            class="font_inter font-semibold text-[46px] md:text-[50px] xl:text-[100px] text-white leading-none uppercase secleft-to-right-animation flex flex-col">
                            <span class="inline-block">Who</span>
                            <span class="inline-block whitespace-nowrap">We Are</span>
                        </h2>
                        <div class="w-full mb-4 secleft-to-right-width-animation" style="border: 1px solid #FFFFFF8C;">
                        </div>
                    </div>
                ...
                <p
                    class="py-5 text-white font_inter font-medium text-[18px] xl:text-[36px] lg:w-[30%] xl:w-[60%] secleft-to-right-animation">
                    Navigate Your Canadian Immigration Journey with Confidence</p>
        ...
        <div class="Navigatesec gradient-evition relative overflow-hidden z-10 bg-[#051b3b]">
            <div class="container mx-auto px-5 lg:px-12 lg:py-16 h-full w-full">
                ...
                <div class="md:flex justify-between items-start gap-5">
                    <div class="md:w-1/2">
                        <h4 class="text-white font_inter font-semibold text-[22px] lg:text-[30px] lg:w-[75%]">Navigate Your
                            Canadian Immigration Journey with Confidence</h4>
                        <p class="text-white font_inter font-thin text-justify text-[14px] py-4  lg:w-[75%]">We enable some
                            of the most demanding organizations to enrich customer experiences, optimize efficiencies,
                            launch new platforms, and monetize data opportunities. We offer fully-managed and end-to-end
                            technology, tools, talent, </p>
                    ...
                    <div class="Navigatesec-image grid grid-cols-2 gap-4 bg-[#0d2139] lg:w-1/2 mb-4 lg:mb-0">
                        ...
                        <div class="flex justify-center items-center rounded-lg overflow-hidden">
                            <img src="{{ asset('assets/home_Banner/immigraton.png') }}" alt="Immigration"
                                class="w-full h-full object-cover" />
                        </div>

                        <!-- Right Side (Spans both rows) -->
                        <div class="row-span-2 rounded-lg overflow-hidden">
                            <img src="{{ asset('assets/home_Banner/cityrectangle.png') }}" alt="Cityscape"
                                class="w-full h-full object-cover" />
                        </div>

                        <!-- Bottom Left -->
                        <div class="flex justify-center items-center rounded-lg overflow-hidden">
                            <img src="{{ asset('assets/home_Banner/suareman.png') }}" alt="Lawyer"
                                class="w-full h-full object-cover" />
                        </div>
                    </div>
                </div>
            ...
            <div class="container mx-auto px-5 lg:px-12 py-6 lg:py-16 h-full w-full">
                <div class="md:flex justify-center items-start gap-5">
                    <div class="RegulatedSec-left md:w-1/2">
                        <h2 class="text-white font_inter font-semibold text-2xl lg:text-3xl xl:text-4xl">Regulated Canadian
                            Immigration Consultants (RCIC-IRB)</h2>
                        <p class="py-5 text-white font-normal font_inter text-[14px] xl:text-lg lg:py-10">Proudly regulated
                            by and in good standing with the College of Immigration and Citizenship Consultants (CICC).
                            Jamie Dowla, registration #: R507233</p>
                            ...
                            @foreach ($certificate as $data)
                                <div>
                                    <img class="w-[200px]"
                                        src="{{ $locationData['storage_server_path'] . $locationData['storage_image_path'] . $data->image }}"
                                        alt="">
                                    <h6 class="font_inter font-semibold text-white text-[14px] w-[80%] text-center py-2">
                                        {{ $data->title }} {{ $data->sub_title }}</h6>
                                </div>
                            @endforeach
                        </div>
                    </div>
        ...
        <div class="testimonial bg-[#051b3b] gradient-evition relative overflow-hidden z-10">
            <div class="container mx-auto px-5 lg:px-12 py-8 lg:py-16 h-full w-full">
                <div class="flex items-end w-full gap-2 lg:gap-7">
                    <h2
                        class="uppercase text-white font_inter font-semibold text-[30px] md:text-[50px] xl:text-[65px] leading-none thirdleft-to-right-animation">
                        Testimonials</h2>
                    <div class="w-full thirdleft-to-right-width-animation"
                        style="border: 2px solid #FFFFFF8C;margin-bottom: 8px;"></div>
                </div>
                <p
                    ...
                    Let’s See what our customers want to say</p>
                <p
                    class="text-white font_inter font-normal text-justify text-[14px] md:w-[45%] thirdleft-to-right-animation">
                    We enable some of the most demanding organizations to enrich customer experiences, optimize
                    efficiencies, launch new platforms, and monetize data opportunities. We offer fully-managed and
                    end-to-end technology, tools, talent, </p>
            </div>
                        ...
                        <div class="w-full py-4 px-4">
                            <div class="flex items-center justify-end">
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <img class="w-[12px]" src="{{ asset('assets/Navigation/ratingstar.png') }}"
                                        alt="">
                                    @endfor
                                </div>
                            </div>
            ...
            <div
                class="container mx-auto px-5 lg:px-12 py-8 lg:py-16 h-full w-full flex flex-col-reverse md:flex-row gap-4 items-center justify-between relative z-20">
        ...
        <div class="BlogCRDS bg-[#051b3b]">
            <div class="container mx-auto px-5 lg:px-12 lg:py-16 h-full w-full">
                <div class="flex items-end w-full gap-2 lg:gap-7">
                    <h2
                        class="uppercase text-white font_inter font-semibold text-[30px] md:text-[50px] xl:text-[65px] leading-none fourthleft-to-right-animation">
                        Blogs</h2>
                ...
                <p
                    ...
                    Canadian Immigration News, Tips, and Resources</p>
                <p
                    class="text-white font_inter font-normal text-justify text-[14px] md:w-[45%] fourthleft-to-right-animation">
                    Stay in the loop and keep up with all our news and updates!</p>
                            ...
                            <div class="py-4 px-6">
                                <div class="flex items-center gap-4">
                                    <img class="w-[50px] h-[50px]"
                                        ...
                                        alt="profile_image" />
                                    <div>
                                        <h6 class="font_inter font-semibold text-16px text-[#072558]">{{ $data->name }}
                                        </h6>
                                        <?php $date = $data->date . ' ' . $data->time; ?>
                                        <p class="text-[#072558] font_inter font-medium text-[14px]">
                                            by {{ $data->name }}, on {{ date('M j, Y h:i:s A', strtotime($date)) }}</p>
                                        <p class="text-[#072558] font_inter font-medium text-[14px]">Topics:
                                            {{ $data->topics }}</p>
                                    </div>
                                </div>
                                <h5 class="text-[#072558] font_inter font-bold text-[14px] py-5">{{ $data->title }}</h5>
                                <p class="text-[#072558] font_inter font-normal text-justify text-[14px]">
                                    {{ $data->description }} </p>
                            </div>
                        </div>
                    @endforeach
        ...
        <div class="explore-section bg-black">
            <div class="container mx-auto px-5 lg:px-12 py-8 lg:py-16 h-full w-full">
                <div class="flex items-end w-full gap-2 lg:gap-7">
                    <h2
                        class="uppercase text-white font_inter font-semibold text-[30px] md:text-[50px] xl:text-[65px] leading-none fifthleft-to-right-animation">
                        Explore</h2>
                ...
                <p class="text-white font_inter font-semibold text-[26px] lg:w-[35%] mt-6 fifthleft-to-right-animation">
                    Learn About All of the Great ThingsCanada Has to Offer!</p>
            </div>
        ...
        <div class="container mx-auto px-5 lg:px-12 py-8 lg:py-16 h-full w-full">
            ...
            <div class="flex justify-center py-6">
                <div
                    ...
                    <h6
                        class="relative z-10 text-white text-[10px] md:text-[12px] xl:text-[16px] transition-colors duration-500 group-hover:text-[#072558]">
                        Let's turn your vision into reality.</h6>

                    <!-- "Connect Us" button, background changes to #072558 on hover -->
                    <div
                        class="relative z-10 bg-white text-blue-600 px-[20px] py-1 lg:pb-[2px] lg:pt-0 xl:py-[6px] md:rounded-sm cursor-pointer w-fit lg:rounded-full whitespace-nowrap rounded-full transition-all duration-500 group-hover:bg-[#072558] group-hover:text-white">
                        <a href="" class="h-full text-[12px] xl:text-[16px]">Connect Us</a>
                    </div>
                </div>
            </div>
        ...
        <div class="container mx-auto px-5 lg:px-12 h-full w-full">
            <div class="flex justify-center items-center flex-col ">
                <div class="flex flex-col-reverse md:flex-row items-center">
                    <h2
                        class="font_inter font-semibold text-4xl text-center md:text-left gettouch uppercase gradient-text">
