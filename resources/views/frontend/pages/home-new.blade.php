        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-20 overflow-hidden">
                            ...
                            <div class="blog-card-mobile md:w-1/3 flex-shrink-0 px-3 opacity-0 animate-fade-in-up" style="animation-delay: {{ $index * 0.1 }}s; animation-fill-mode: forwards;">
                                <div class="bg-blue-800 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 border border-blue-700 overflow-hidden h-full">
                                    ...
                                    <div class="p-6">
                                        ...
                                        {{-- Read More Button --}}
                                        <a href="{{ url('blog-details/' . ($article->slug ?? $article->id)) }}" class="inline-flex items-center text-blue-300 hover:text-blue-200 font-medium transition-colors group">
                                            Read More
                ...
                <div class="flex justify-center mt-12">
                    <a
                        href="{{ url('blogs') }}"
                        class="inline-flex items-center justify-center gap-3 px-8 py-4 bg-transparent border-2 border-blue-400 text-blue-300 hover:bg-blue-400 hover:text-white rounded-full font-semibold text-lg transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-400 group"
                    >
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
