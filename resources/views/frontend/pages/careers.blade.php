...
@section('content')
    ...
    <script>
        function handleFileChange(index) {
            ...
            let inputsec = document.getElementById(`imageUploadersec-${index}`);
            ...
            if (inputsec.files && inputsec.files.length > 0) {
                iconsec.style.filter = 'hue-rotate(270deg) brightness(2.5)';
            } else {
                iconsec.style.filter = 'none';
            }
        }
