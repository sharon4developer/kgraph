        ...
        <div class="flex flex-col justify-center items-start h-full w-full text-left text-white z-10 md:mt-[16%] lg:mt-[95px] 2xl:mt-[40px]">
            ...
            <div class="flex flex-col lg:flex-row items-start justify-between gap-4 mt-5 md:mt-8 lg:mt-[2.30rem] lg:gap-20">
                ...
                <div class="w-full cursor-pointer">
                    <img class="duration-300 ease-linear hover:scale-105" src="@if(isset($aboutUs)) {{ $locationData['storage_server_path'].$locationData['storage_image_path'].$aboutUs->about_image }} @endif" alt="@if(isset($aboutUs)) {{$aboutUs->about_image_alt_tag}} @endif">
                </div>
            </div>
        </div>
    </div>
...
<div class="cta bg-[#062358]">
    <div class="container px-5 mx-auto lg:px-12">
        <div class="bg-blue-50">
            <section class="flex flex-col items-center p-8 space-y-8 lg:flex-row lg:p-16 lg:space-y-0 lg:space-x-12">
                <div class="text-center lg:w-2/3 lg:text-left">
                    ...
                    <p class="mt-4 leading-relaxed text-justify text-gray-700">
                        {{$crew->description}}
                ...
                <div class="items-center justify-center lg:w-1/3 lg:flex">
...
<div class="cta bg-[#062358]">
    <div class="container relative z-10 px-5 py-8 mx-auto lg:px-12">
        <div class="flex flex-wrap items-center justify-start gap-6 lg:py-8">
            ...
            <div class="crew-card" bis_skin_checked="1">
                ...
                <div class="crew-card-content" bis_skin_checked="1">
                    ...
                    <div class="text-white address" bis_skin_checked="1">
                        <p class="text-white">Canada</p>
                        <p class="text-white email-link">{{$item->email}}</p>
                    </div>
                    {{-- <a class="text-white read-bio-link" href="#">Read full bio &gt;</a> --}}
                </div>
            </div>
            @endforeach
{{--
            <div class="crew-card" bis_skin_checked="1">
                ...
                <div class="text-white crew-card-content" bis_skin_checked="1">
                    <h5 class="text-white">Mathews Benny</h5>
                    <h6 class="text-white">Director</h6>
                    <div class="text-white address" bis_skin_checked="1">
                        <p class="text-white">Canada</p>
                        <a class="text-white email-link" href="mail.canada@kgraph.ca">canada@kgraph.ca</a>
                    </div>
                    <a class="text-white read-bio-link" href="#">Read full bio &gt;</a>
                </div>
            </div> --}}
    ...
    <div class="container relative z-10 px-5 py-8 mx-auto lg:px-12">
        ...
        {{-- <div class="md:py-10">
            ...
            <div class="about-meet-slider">
                <div class="splide__track">
                    <ul id="crew-list" class="gap-8 splide__list">
        ...
        <div class="lg:my-16">
            ...
            <div class="md:flex items-end gap-[45px] mt-5">
                ...
                <div class="my-6 md:my-0 lg:mt-[-51px] flex flex-wrap md:flex-nowrap items-center gap-5 lg:gap-[50px]">
                    <div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center whitespace-nowrap">
                            <span class="block leading-none text-white">Google Rating</span>
...
<div id="aboutOurStory" class="h-full my-10 bg-white our-story">
    <div class="container px-5 mx-auto lg:px-12">
        <h2>@if(isset($aboutUs)) {{$aboutUs->our_story_title}} @endif</h2>

        <div class="flex items-center justify-center mt-6">
            <div class="h-[2px] w-[95vw] bg-[#0E3065]">
                <div id="movebarparent" class="container relative flex items-center w-full h-full px-5 mx-auto lg:px-12">
                    <div class="absolute bottom-0 hidden lg:block rasing-falg-wrpr" style="">
    ...
    <div class="container px-5 mx-auto lg:px-12">
        <div class="flex flex-col lg:flex-row items-center lg:items-start gap-[50px] mt-6">
            ...
            <div id="newaboutSplide" class="splide flex items-center w-[79%] md:w-[90%] lg:w-[90%] xl:w-[94%]">
                <div class="splide__track">
                    <ul class="splide__list">
                        ...
                        <li class="flex flex-col items-center justify-around gap-6 splide__slide md:flex-row">
                            <!-- Left Section -->
        ...
        <div class="flex flex-col lg:flex-row lg:gap-[10%] mt-9 py-4">
            ...
            <div class="w-full lg:w-1/2 grid grid-cols-2 gap-4 lg:gap-[12px] py-8">
                ...
                <div class="flex justify-center items-center rounded-lg overflow-hidden h-[260px]">
                    <img src="@if(isset($aboutUs)) {{ $locationData['storage_server_path'].$locationData['storage_image_path'].$aboutUs->location_image1 }} @endif" alt="@if(isset($aboutUs)) {{$aboutUs->location_image1_alt_tag}} @endif" class="object-cover w-full h-full">
                </div>

                <!-- Right Large Image -->
                <div class="row-span-2 rounded-lg overflow-hidden h-[400px]">
                    <img src="@if(isset($aboutUs)) {{ $locationData['storage_server_path'].$locationData['storage_image_path'].$aboutUs->location_image2 }} @endif" alt="@if(isset($aboutUs)) {{$aboutUs->location_image2_alt_tag}} @endif" class="object-cover w-full h-full">
                </div>

                <!-- Bottom Left Image -->
                <div class="flex justify-center items-center rounded-lg overflow-hidden h-[121px]">
                    <img src="@if(isset($aboutUs)) {{ $locationData['storage_server_path'].$locationData['storage_image_path'].$aboutUs->location_image3 }} @endif" alt="@if(isset($aboutUs)) {{$aboutUs->location_image3_alt_tag}} @endif" class="object-cover w-full h-full">
                </div>
            </div>
        </div>
...
<div class="open-positions bg-[#04183c]">
    <div class="container mx-auto px-5 xl:px-12 h-full w-full py-8 lg:py-[8%] text-white">
        <div class="flex items-end w-full gap-2 lg:gap-7">
            <h2 class="uppercase text-white font_inter font-semibold text-[30px] lg:text-[45px] leading-normal thirdleft-to-right-animation">@if(isset($aboutUs)) {{$aboutUs->location_title}} @endif</h2>
            <div class="w-full thirdleft-to-right-width-animation" style="border: 1px solid #FFFFFF8C;margin-bottom: 8px;"></div>
        </div>
        <h4 class="font_inter font-semibold text-[20px] text-white py-8">@if(isset($aboutUs)) {{$aboutUs->location_sub_title}} @endif</h4>



        <div class="lg:grid lg:grid-cols-3 lg:gap-6 py-[56px]">
            @foreach ($locations as $data)
