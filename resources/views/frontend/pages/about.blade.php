...
@section('content')
    ...
    <div class="aboutusbanner relative h-full">
        ...
        <div class="container mx-auto px-5 lg:px-12 h-full w-full py-8 lg:py-[8%]">
            <div
                class="flex flex-col justify-center items-start h-full w-full text-left text-white z-10 md:mt-[16%] lg:mt-12 xl:mt-8">
                ...
                <div class="flex items-center gap-4 py-8 lg:py-2 xl:py-4">
                    <h3 class="font_inter font-normal text-[15px] lg:text-[20px] text-justify">Take a sneak peek in to our
                        journey</h3>
                ...
                <div class="flex flex-col lg:flex-row items-center justify-between gap-4 lg:gap-20">
                    ...
                    <div class="w-full cursor-pointer">
                        <img class="hover:scale-105 ease-linear duration-300"
                            src="{{ asset('assets/about/videodummy.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="cta bg-[#062358]">
        <div class="container mx-auto px-5 lg:px-12 py-8 translate-large z-10 relative">
            ...
            <div class="md:py-10">
                ...
                <div id="crew-list-pagination"></div>
            </div>
            ...
            <div class="">
                ...
                <div class="md:flex items-end gap-[45px] mt-5">
                    ...
                    <div class="my-6 md:my-0 flex flex-wrap md:flex-nowrap items-start gap-5">
                        <div>
                            <h2 class="text-white font_inter font-bold text-[25px] leading-none">@if (isset($journey))
                                {{ $journey->employees }}
                            @endif</h2>
    ...
    <div id="aboutOurStory" class="bg-white our-story my-10 h-full">
        <div class="container mx-auto px-5 lg:px-12">
            ...
            <div class="mt-6 flex justify-center items-center">
                <div class="h-[2px] w-[95vw] bg-[#0E3065]">
                    <div id="movebarparent"
                        class="container mx-auto px-5 lg:px-12 w-full h-full flex items-center relative">
                        <div class="hidden lg:block absolute bottom-0" style="right: -5%;z-index: 10;top: -48px;">
                            <img class="w-[340px] h-[250px]" src="{{ asset('assets/home_Banner/canadaanimated.png') }}"
                                alt="">
                        </div>
        ...
        <div class="pl-5 lg:pl-[9rem] 2xl:pl-12 bigscreen-sizing py-8 flex flex-col-reverse lg:flex-row overflow-x-hidden">
            <div class="flex justify-end lg:justify-start items-center gap-3 lg:pt-[3%] mr-4">
                <div
                    class="aboutnext bg-[#062358] rounded-full w-8 h-8 flex justify-center items-center text-white font-semibold cursor-pointer pb-[3.5px]">
                    <</div>
                        <div
                            class="aboutprev bg-[#062358] rounded-full w-8 h-8 flex justify-center items-center text-white font-semibold cursor-pointer pb-[3.5px]">
                            ></div>
                </div>
                <div class="flex items-center w-[100vw] about-slider xl:pt-[4%]">
                    ...
                    <div class="flex flex-col gap-4 w-[100vw]">
                        <div class="flex items-end md:gap-10">
                            <h5 class="pl-[30px] text-[#072558] font_inter font-semibold text-[10px] xl:text-[16px]">{{$data->year}}
                            </h5>
                        ...
                        <div class="flex gap-8 pl-[6%] pt-2">
                            <h3
                                class="w-[25%] text-[#07245A] font_inter font-semibold md:text-[10px] text-[5px] xl:text-[12px]">
                                {{$data->title}}</h3>
                            <p
                                class="w-[50%] text-[#07245A] opacity-40 font_inter font-semibold text-[5px] md:text-[10px] xl:text-[16px]">
                                {{$data->description}}
                            </p>
                        </div>
                    </div>
        ...
        <div class="loaction bg-[#062358] gradient-evition relative overflow-hidden z-10">
            <div class="container mx-auto px-5 lg:px-12 h-full w-full py-12">
                <div class="flex items-end w-full gap-2 lg:gap-7">
                    <h2
                        class="uppercase text-white font_inter font-semibold text-[30px] lg:text-[45px] leading-none thirdleft-to-right-animation">
                        Locations</h2>
                ...
                <div class="lg:flex lg:gap-[10%] mt-9">
                    <div class="w-full mb-6 lg:mb-0">
                        <h4 class="font_inter font-semibold text-[20px] text-white py-4">Find Your Licensed Immigration
                            ConsultantWherever You Are Located</h4>
                        <div class="grid gap-3 aboutnow knowbutton" style="">
                            @foreach ($locations as $data)

                            <button
                                class="flex items-center justify-between gap-4 border border-white rounded-full px-6 py-2">
