        ...
        <div class="container mx-auto px-5 lg:px-12 h-full w-full py-8 md:pt-[15%] lg:py-[3%] text-white relative z-10">
            <div bottomtotoppara class="lg:w-1/2 opacity-0 translate-y-20">
                ...
                <p class="text-sm font-medium font_inter mb-3">Studying in America can be an exciting experience, but it also comes 
                    ...
                    student visa approved by the US embassy or consulateLorem Ipsum is simply dummy text of the printing and typesetting industry.
                </p>
            </div>
            ...
            <div class="grid cards grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-[64px] gap-4">
                <div class="bg-white card rounded-[26px] text-[#062358] p-6">
                    ...
                    <div>
                        <h3 class="mb-3 capitalize font_inter font-bold text-xl">Study in Canada</h3>
                        <p class="clamp-text-seven font_inter text-sm">Studying in America can be an exciting experience, but it also comes with its own set of challenges. One such challenge is getting your US student visa approved by the US embassy or consulateLorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    </div>
                </div>
        ...
        <div class="container mx-auto px-5 lg:px-12 h-full w-full py-8 md:pt-[15%] lg:py-[3%]">
            ...
            <div lefttoslider class="mt-[4%] opacity-0 -translate-x-20">
                    ...
                    <div class="splide__track">
                        <ul class="splide__list">
                            <li class="splide__slide">
                                <img class="h-[200px] md:h-[260px] w-full md:w-[430px] rounded-[25px] object-cover" src="{{ asset('assets/home_Banner/contactUsbackground.webp') }}" alt="">
                            </li>
                            <li class="splide__slide">
                                <img class="h-[200px] md:h-[260px] w-full md:w-[430px] rounded-[25px] object-cover" src="{{ asset('assets/home_Banner/contactUsbackground(2).webp') }}" alt="">
                            </li>
                            <li class="splide__slide">
                                <img class="h-[200px] md:h-[260px] w-full md:w-[430px] rounded-[25px] object-cover" src="{{ asset('assets/home_Banner/Canadas.jpeg') }}" alt="">
                            </li>
                            <li class="splide__slide">
                                <img class="h-[200px] md:h-[260px] w-full md:w-[430px] rounded-[25px] object-cover" src="{{ asset('assets/home_Banner/contactUsbackground.webp') }}" alt="">
                            </li>
                ...
                <div class="flex justify-center items-center gap-5 mt-7">
                    <div><button id="prev-slide"><img class="w-[50px]" src="{{ asset('assets/Button-Previous.png') }}" alt=""></button></div>
    ...
    <div class="container mx-auto px-5 xl:px-12 py-8 lg:py-16 h-full w-full">
        <div class="flex justify-center items-center flex-col">
            ...
            <div class="my-6">
                ...
                <img class="mt-[-11px] w-[100px]" src="{{ asset('assets/home_Banner/underlinefaq.png') }}" alt="">
            </div>
        </div>
