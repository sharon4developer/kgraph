...
<div class="b-backgroun-nav z-50 w-full">
    <header id="immaintop" class="text-white hidden md:block bg-black md:fixed top-0 z-50 w-full">
        <div class="container mx-auto px-5 lg:px-12 flex justify-between items-start lg:items-center gap-1 lg:gap-0 flex-col md:flex-row font_aktiv py-[12px] lg:py-[10px] opacity-50">
            <div>
                <small class="uppercase font-light text-[13px] font_aktiv">KGRAPH IMMIGRATION CONSULTANCY INC.</small>
            </div>
            <div class="flex items-center gap-12">
                <div class="capitalize hidden lg:flex">
                    <ul class="flex items-center gap-1 text-sm font-light text-[10px] 2xl:text-[13px]">
                ...
                <small class="capitalize font-light text-[13px] font_aktiv">© 2024 - CanDo Canadian Immigration Services.</small>
            </div>
        </div>
    </header>
    ...
    <nav id="imHeader" class="text-white bg-gradient-to-b from-black to-transparent md:fixed top-10 !z-50 w-full overflow-hidden">
        <div class="flex items-center justify-between container mx-auto px-5 lg:px-12 py-4 lg:py-5">
            ...
            <div class="capitalize hidden lg:flex gap-4">
                <ul class="flex items-center gap-4 text-base font_inter font-light">
