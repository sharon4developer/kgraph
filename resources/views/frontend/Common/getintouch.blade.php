...
<div class="get-in-Touch bg-[#051b3b] py-28">
    <div class="container mx-auto px-5 xl:px-12 h-full w-full">
        <div class="flex justify-center items-center flex-col ">
            ...
            <p class="text-white py-6 lg:py-6 2xl:py-10 paddadjuster md:w-3/5 lg:w-[40%]  text-center font_inter font-semibold text-[14px] 2xl:text-[22px] gettouchpara">Labaton Keller Sucharow is elevating excellence through innovation, client service, and teamwork.</p>
