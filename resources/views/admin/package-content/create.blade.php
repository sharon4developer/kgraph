        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Package Contents</h4>
                </div>
                <div class="card-body">
                    <form class="needs-validation" novalidate id="package-add-form" method="POST">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <div class="form-group">
                                        <label class="form-label" for="ckeditor-classic">Package Description</label>
                                        <textarea type="text" class="form-control" id="package_description" name="package_description"
                                        placeholder="Package Description" required></textarea>
                                        <div class="valid-feedback">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <a type="button" href="{{ url('admin/package-contents') }}"
...
@endpush
@push('script')
    <script src="{{ asset('admin/backend/js/package-content.js') }}"></script>
@endpush
