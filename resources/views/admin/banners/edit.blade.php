                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <textarea id="sub_title" name="sub_title" aria-describedby="sub_title_help">{{ $data->sub_title ?? '' }}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" name="description" aria-describedby="description_help">{{ $data->description ?? '' }}</textarea>
