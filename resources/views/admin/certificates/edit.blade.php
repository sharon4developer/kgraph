    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="needs-validation" novalidate id="certificate-edit-form" method="POST">
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <div class="form-group">
                                        <label class="form-label" for="sub_title">Sub Title<span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <a type="button" href="{{ url('admin/certificates') }}"
...
@endpush
@push('script')
    <script src="{{ asset('admin/backend/js/certificates.js') }}"></script>
@endpush
