        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Sub Service Point Contents</h4>
                </div>
                <div class="card-body">
                    <form class="needs-validation" novalidate id="service-add-form" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <div class="form-group">
                                        <label class="form-label" for="sub_title">Select Service Point</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <a type="button" href="{{ url('admin/sub-service-point-contents') }}"
