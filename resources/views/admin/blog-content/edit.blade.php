                    ...
                    <form class="needs-validation" novalidate id="blog-edit-form" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <div class="form-group">
                                        <label class="form-label" for="ckeditor-classic">Blog Description</label>
                                        <textarea type="text" class="form-control" id="blog_description" name="blog_description"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <a type="button" href="{{ url('admin/blog-contents') }}"
...
@endpush
@push('script')
    <script src="{{ asset('admin/backend/js/blog-content.js') }}"></script>
@endpush
