        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Edit Service Point Contents</h4>
                </div>
                <div class="card-body">
                    <form class="needs-validation" novalidate id="service-edit-form" method="POST">
                        @method('PUT')
                        <input type="hidden" name="service_point_content_id" value="{{ $data->id }}">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                        ...
                                        <select class="form-select" name="service_id">
                                            ...
                                            @foreach ($services as $service)
                                                <option value="{{ $service->id }}"
                                                    @if ($service->id == $data->sub_service_point_id) selected @endif>{{ $service->title }}
                                                    ({{ $service->Services->title }})</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <a type="button" href="{{ url('admin/service-content-options') }}"
