    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="needs-validation" novalidate id="resource-add-form" method="POST">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" id="excerpt" name="excerpt"
                                            placeholder="Short summary shown on the listing page"></textarea>
                                        <div class="valid-feedback">
                                        </div>
                                    </div>
                                </div>
...
$(document).ready(function() {
    ...
    function setupImportHandlers() {
        $('#import-google-docs').on('click', function() {
            ...
            $.ajax({
                url: $("#route-for-user").val() + '/resources/import/google-docs',
                method: 'POST',
                headers: {
                        ...
                        try {
                            ...
                            if (editor) {
                                ...
                                if (typeof showMessage === 'function') {
                                    showMessage('success', data.message || 'Content imported successfully!');
                                } else {
                ...
                error: function(xhr, status, error) {
                    ...
                    if (xhr.responseJSON && xhr.responseJSON.message) {
                        ...
                        errorMsg += 'Please ensure the document is publicly accessible.';
                    }
                    alert(errorMsg);
                },
                complete: function() {
