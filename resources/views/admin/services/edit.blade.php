                                        ...
                                        <select class="form-select" id="service_category_id" name="service_category_id">
                                            ...
                                            @foreach ($serviceCategories as $category)
                                                <option value="{{ $category->id }}"
                                                    @if ($category->id == $data->service_category_id) selected @endif>{{ $category->title }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" name="description" aria-label="Description editor">{{ $data->description ?? '' }}</textarea>
                                        <div class="valid-feedback">
                                        </div>
                                    </div>
                                </div>
