                    ...
                    <div class="px-3" data-simplebar style="max-height: 386px;">
                        <div class="d-flex align-items-center pb-4">
                            <div class="avatar-md me-4">
                                <img src="{{ asset('admin/theme/assets/images/users/avatar-2.jpg') }}" class="img-fluid rounded-circle"
                                    alt="">
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center pb-4">
                            <div class="avatar-md me-4">
                                <img src="{{ asset('admin/theme/assets/images/users/avatar-4.jpg') }}" class="img-fluid rounded-circle"
                                    alt="">
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center pb-4">
                            <div class="avatar-md me-4">
                                <img src="{{ asset('admin/theme/assets/images/users/avatar-5.jpg') }}" class="img-fluid rounded-circle"
                                    alt="">
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center pb-4">
                            <div class="avatar-md me-4">
                                <img src="{{ asset('admin/theme/assets/images/users/avatar-6.jpg') }}" class="img-fluid rounded-circle"
                                    alt="">
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center pb-4">
                            <div class="avatar-md me-4">
                                <img src="{{ asset('admin/theme/assets/images/users/avatar-8.jpg') }}" class="img-fluid rounded-circle"
                                    alt="">
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center pb-3">
                            <div class="avatar-md me-4">
                                <img src="{{ asset('admin/theme/assets/images/users/avatar-9.jpg') }}" class="img-fluid rounded-circle"
                                    alt="">
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <table class="table align-middle table-nowrap">
                            <tbody>
                                <tr>
                                    <td style="width: 50px;">
                                        <div class="avatar-md me-4">
                                            <img src="{{ asset('admin/theme/assets/images/product/img-1.png') }}" class="img-fluid"
                                                alt="">
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 50px;">
                                        <div class="avatar-md me-4">
                                            <img src="{{ asset('admin/theme/assets/images/product/img-2.png') }}" class="img-fluid"
                                                alt="">
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 50px;">
                                        <div class="avatar-md me-4">
                                            <img src="{{ asset('admin/theme/assets/images/product/img-3.png') }}" class="img-fluid"
                                                alt="">
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 50px;">
                                        <div class="avatar-md me-4">
                                            <img src="{{ asset('admin/theme/assets/images/product/img-4.png') }}" class="img-fluid"
                                                alt="">
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 50px;">
                                        <div class="avatar-md me-4">
                                            <img src="{{ asset('admin/theme/assets/images/product/img-5.png') }}" class="img-fluid"
                                                alt="">
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 50px;">
                                        <div class="avatar-md me-4">
                                            <img src="{{ asset('admin/theme/assets/images/product/img-6.png') }}" class="img-fluid"
                                                alt="">
                                        </div>
                                    </td>
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li>
                                <div class="conversation-list">
                                    <div class="d-flex">
                                        <img src="{{ asset('admin/theme/assets/images/users/avatar-3.jpg') }}" class="rounded-circle avatar-sm"
                                            alt="">
                                        <div class="flex-1">
                            ...
                            <li class="right">
                                <div class="conversation-list">
                                    <div class="d-flex">
                                        ...
                                        <img src="{{ asset('admin/theme/assets/images/users/avatar-6.jpg') }}" class="rounded-circle avatar-sm"
                                            alt="">
                                    </div>
                                                    ...
                                                    <ul class="list-inline message-img mt-3  mb-0">
                                                        <li class="list-inline-item message-img-list">
                                                            <a class="d-inline-block m-1" href="">
                                                                <img src="{{ asset('admin/theme/assets/images/small/img-1.jpg') }}" alt=""
                                                        ...
                                                        <li class="list-inline-item message-img-list">
                                                            <a class="d-inline-block m-1" href="">
                                                                <img src="{{ asset('admin/theme/assets/images/small/img-2.jpg') }}" alt=""
                                                                    class="rounded img-thumbnail">
                                                            </a>
                                                        </li>
                                                    </ul>
