        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Edit Crew</h4>
                </div>
                <div class="card-body">
                    <form class="needs-validation" novalidate id="crew-edit-form" method="POST">
                        @method('PUT')
                        <input type="hidden" name="crew_id" value="{{$data->id}}">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <a type="button" href="{{ url('admin/crew') }}"
...
@endpush
@push('script')
    <script src="{{ asset('admin/backend/js/crew.js') }}"></script>
@endpush
