                                            ...
                                            <div class="card-body" id="options-container-{{ $titleIndex }}">
                                                ...
                                                @if ($titles->options->isNotEmpty())
                                                    @foreach ($titles->options as $optionIndex => $option)
                                                        <div class="option-item mt-3" id="option_{{ $titleIndex }}_{{ $optionIndex }}">
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                ...
                                                                <div class="col-md-6" id="multi-options_{{ $titleIndex }}_{{ $optionIndex }}">
                                                                    ...
                                                                    <div class="multi-option-item mt-2" id="multi-option_${titleId}_${optionId}_${multiOptionIndex}">
                                                                        <input type="text" class="form-control" required
                                                                            ...
                                                                            value="{{ $option->value }}">
                                                                        <!-- Sub-Options -->
                                                                        <div id="sub-options_{{ $titleIndex }}_{{ $optionIndex }}_{{$multiOptionIndex}}" class="mt-3">
                                                                            @foreach ($option->subOptions as $subOptionIndex => $subOption)
                                                                                <div class="sub-option-item mt-2" id="sub-option_{{ $titleIndex }}_{{ $optionIndex }}_{{$multiOptionIndex}}_{{ $subOptionIndex }}">
                                                                                    <div class="row">
                                                                                        <div class="col-md-10">
                                                                                            <input type="text" class="form-control" required
                                                                                        ...
                                                                                        <div class="col-md-2">
                                                                                            <button type="button" class="btn btn-outline-danger btn-sm remove-sub-option"
                                                                                                data-title-id="{{ $titleIndex }}"
                                                                                                data-option-id="{{ $optionIndex }}"
                                                                                                data-multi-option-id="{{$multiOptionIndex}}"
                                                                                                data-sub-option-id="{{ $subOptionIndex }}">Remove Sub-Option</button>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            @endforeach
                                                                    ...
                                                                    <button type="button" class="btn btn-outline-secondary btn-sm add-sub-option"
                                                                        data-title-id="{{ $titleIndex }}"
                                                                        data-option-id="{{ $optionIndex }}"
                                                                        data-multi-option-id="{{$multiOptionIndex}}">+ Add Sub-Option</button>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <button type="button" class="btn btn-outline-danger btn-sm remove-option"
                                                                        data-title-id="{{ $titleIndex }}"
                                                                        data-option-id="{{ $optionIndex }}"
                                                                        data-multi-option-id="{{$multiOptionIndex}}">Remove Option</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                ...
                                                @if ($titles->paragraphs->isNotEmpty())
                                                    ...
                                                    <?php $paragraphIndex = $optionIndex + $paragraphIndex + 1 ; ?>
                                                        ...
                                                        <div class="option-item mt-3" id="option_{{ $titleIndex }}_{{ $paragraphIndex }}">
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <select class="form-control option-type"
                                                                        data-title-id="{{ $titleIndex }}"
                                                                        ...
                                                                        <option value="paragraph" {{ $paragraph->type === 'paragraph' ? 'selected' : '' }}>Paragraph</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-6" id="option-content_{{ $titleIndex }}_{{ $paragraphIndex }}">
                                                                    <textarea class="form-control" required
                                                                        name="titles[{{ $titleIndex }}][options][{{ $paragraphIndex }}][content]">{{ $paragraph->content }}</textarea>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <button type="button" class="btn btn-outline-danger btn-sm remove-option"
                                                                        data-title-id="{{ $titleIndex }}"
                                                                        data-option-id="{{ $paragraphIndex }}">Remove Option</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endforeach
