                ...
                .getElementsByTagName("tbody")[0],
            {
                onEnd: function (event) {
                    ...
                    $.ajax({
                        url:
                            $("#route-for-user").val() +
                            "/sub-service-point-contents/update/order", // Replace with your Laravel route URL
                        method: "POST",
                        data: {
                            order: newOrder,
                        },
...
function loadDataTableForServices() {
    table = $("#service-details-table").DataTable({
        ...
        ajax: {
            url:
                $("#route-for-user").val() + "/sub-service-point-contents/show",
            dataType: "json",
            type: "GET",
            data: function (d) {
            ...
            { data: "title" },
            {
                ...
                render: function (row) {
                    return (
                        ...
                        $("#route-for-user").val() +
                        `/sub-service-point-contents/point-contents/options?service_point_content_id=` +
                        row.id +
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                ...
                url:
                    $("#route-for-user").val() +
                    "/sub-service-point-contents/change/status",
                data: {
                    id: id,
                },
    ...
    $("#select-service").on("change", function () {
        ...
        if (serviceId) {
            ...
            $.ajax({
                url:
                    $("#route-for-user").val() +
                    "/sub-service-point-contents/get/sub-service-points", // Replace with your Laravel route
                type: "GET",
