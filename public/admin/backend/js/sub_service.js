                ...
                .getElementsByTagName("tbody")[0],
            {
                onEnd: function (event) {
                    ...
                    $.ajax({
                        url:
                            $("#route-for-user").val() +
                            "/sub-services/update/order", // Replace with your Laravel route URL
                        method: "POST",
                        data: {
                            order: newOrder,
                        },
...
function loadSeo(service_id) {
    ...
    $.ajax({
        url:
            $("#route-for-user").val() +
            "/sub-services/seo/show?service_id=" +
            service_id,
        type: "GET",
        dataType: "JSON",
        headers: {
...
$(document).ready(function () {
// TinyMCE initialization is now handled in the blade template
// This file no longer needs Quill initialization code
});
